            ...
            <div className="relative z-10 w-full flex flex-col items-center">
                ...
                {showContent && (
                    ...
                    >
                        ...
                        <h2 className="text-3xl md:text-5xl font-bold uppercase text-[var(--color-gold)] font-serif">
                            {content.label}
                        </h2>
                        ...
                        <Link href={content.ctaHref} className="w-full md:w-auto mt-4">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="bg-[var(--color-gold)] text-black font-bold text-lg py-4 px-12 rounded shadow-lg uppercase tracking-wider hover:bg-[#d9b88c] transition-colors w-full md:w-auto"
                            >
                                {content.cta}
                            </motion.button>
                        </Link>
